...
var _Grid=require('./Grid');var _Grid2=_interopRequireDefault(_Grid);function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj;}else{var newObj={};if(obj!=null){for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key))newObj[key]=obj[key];}}newObj.default=obj;return newObj;}}function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Surface=_reactNative.ART.Surface,Shape=_reactNative.ART.Shape,Path=_reactNative.ART.Path,Text=_reactNative.ART.Text,Group=_reactNative.ART.Group;var AnimatedShape=_reactNative.Animated.createAnimatedComponent(Shape);

var makeDataPoint=function makeDataPoint(x,y,data,index){
var label=data.data[index][2]?data.data[index][2]:'';
return{x:x,y:y,radius:data.dataPointRadius,fill:data.dataPointFillColor,
...
dataPoints.push(makeDataPoint(0,height,_this.props,0));
...
path.lineTo(x,y);
fillPath.lineTo(x,y);
dataPoints.push(makeDataPoint(x,y,_this.props,i+1));
});
...
if(i!==0)return(
_react2.default.createElement(Group,{key:i},
_react2.default.createElement(_Circle2.default,d),
_react2.default.createElement(Text,{x:d.x-10,y:d.y-20,fill:d.fill?d.fill:'#000000',font:d.fontLabel?d.fontLabel:'bold 10px "Arial"'},d.label)));
